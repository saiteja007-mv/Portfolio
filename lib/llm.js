...
var MODELS = [
  'nvidia/nemotron-3-nano-30b-a3b:free',    // 30B/3B-active — fast, high throughput
  'qwen/qwen3-next-80b-a3b-instruct:free',  // 80B/3B-active MoE — fast fallback
...
var PROFILE = [
  ...
  '',
  'FEATURED PROJECTS:',
  '1. Multi-Modal Cyberbullying Detection (PyTorch, Transformers, Bi-LSTM, VGG16, OpenCV): classifies cyberbullying across text + image + audio into 6 harm categories in one pipeline. Bi-LSTM text path 83.4% accuracy (0.83 F1), VGG16 image path 96.1% accuracy (0.96 F1), plus a speech-to-text audio path. Published in the JETIR journal.',
  '2. Intelligent Real-Time Traffic Flow Prediction (Python, LSTM, MLOps): real-time traffic prediction for smart-city signal optimization, +15-20% accuracy at under 2s inference, with an end-to-end MLOps pipeline (preprocessing -> training -> dashboards).',
  '',
  'CONTACT & LINKS:',
