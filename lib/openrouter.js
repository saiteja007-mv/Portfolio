...
async function complete(messages, opts) {
  ...
  // Reasoning models (e.g. cohere/north-mini-code) may put text in `reasoning`
  // with content null — accept either so they still work as fallbacks.
  var text = msg && ((msg.content && String(msg.content).trim()) || (msg.reasoning && String(msg.reasoning).trim()));
